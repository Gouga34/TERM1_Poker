...
namespace gui
{
    OptionsDialog::OptionsDialog()
        : QDialog(), m_profiledAiCalibration(new CalibrationChoice("IA profilée")),
            m_profilingAiCalibration(new CalibrationChoice("IA qui profile")),
            m_opponentCalibration(new CalibrationChoice(""))
    {
        //titre fenêtre
        ...
        m_profilingMode = new QRadioButton("Profilage");
        m_optimalCalibrationMode = new QRadioButton("Recherche du calibrage optimal");
        ...
        m_opponentChoice = new QGroupBox("Joueur humain");
        ...
        m_parametersLayout = new QStackedLayout;
