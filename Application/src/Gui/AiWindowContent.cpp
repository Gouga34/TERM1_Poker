...
namespace gui
{
    AiWindowContent::AiWindowContent(game::Game *game, Window *window):WindowContent(game)
    {
        ...
        m_partsState = new QLabel("Parties en cours");
        m_profiledAiCalibration = new QLabel;
    ...
    {
        m_partsSummary = new QTableWidget(0, 8);
    ...
    {
        m_globalResults = new QTableWidget(0, 5);
        ...
        //m_globalResults->setItem(newLine, NB_JEUX_AGRESSIFS, new QTableWidgetItem(QString::number(0)));
    ...
    {
        m_resultsGraph = new QCustomPlot;
