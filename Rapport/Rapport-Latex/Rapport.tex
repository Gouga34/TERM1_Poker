...
\hspace{0.5cm}Pour facilement déterminer si le profilage établi est efficace, et également déterminer le nombre de parties nécessaires pour profiler, nous avons ajouté dans un .csv le profil global établi au fur et à mesure des parties, ainsi que le taux de similarité entre le profilage établi et le calibrage réel de l'adversaire. Nous avons donc pu ajuster le nombre de parties selon cette valeur de similarité.\par
...
Nombre de parties gagnees par l'IA qui profile pendant profilage :	6	sur	10
Nombre de parties gagnees par l'IA qui profile pendant jeu :	15	sur	20
