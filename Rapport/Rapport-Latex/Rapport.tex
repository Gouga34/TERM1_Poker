...
Nous avons donc aussi ajouté dans le fichier le mode de jeu de l'intelligence artificielle, soit profilage ou bien phase de jeu.\\

\section{Profilage}
%%On mettra ici les données communes aux profilages statiques et dynamiques

\section{Phase de jeu}
%%Parler du fait que le but c de gagner le plus de parties et/ou le plus de jetons
