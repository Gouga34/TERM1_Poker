...
\hspace{0.5cm}Lors du démarrage de la phase de développement, nous avons développé parallèlement au jeu, l'interface graphique afin de permettre à un joueur humain de pouvoir jouer face à une intelligence artificielle et de suivre le déroulement d'une partie.\\
