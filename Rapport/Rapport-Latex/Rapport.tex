...
%%%%%%%%%%%%%%%%%%%%%%%TODO%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Trouver un endroit où siter les thèses. %%%%%%%%%%
%% Faire carément une partie dessus ? (Pompidor %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%TODO: parler des 3h de tests pour trouver le calibrage optimal, mettre une courbe pour montrer les résultats et comparer les résultats avec les calibrages précédents %% 
