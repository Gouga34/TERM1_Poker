...
Afin de pouvoir obtenir des résultats facilement observables et pouvoir les étudier, nous avons également produit des graphes représentant le profilage établi du joueur en fonction du nombre de parties, et une constante correspondant au calibrage à déterminer.\\
...
Une fois le profilage lancé, et les premiers résultats obtenus, la méthode de profilage peut alors commencer à se servir des situations précédentes pour calculer l'action attendue d'un joueur de façon plus précise. En effet, selon la situation, il est possible de déterminer quelle va être l'action du joueur en se référant aux scénarios de tests conçus, qui sont communs à tous les joueurs, mais également en se référant aux parties précédentes, si l'on a déjà testé sa réaction précédemment dans une situation équivalente. Les scénarios de tests sont alors mis à jour de façon dynamique.\par 
...
\hline
Nombre de parties gagnées par l'IA qui profile pendant profilage :& 6 sur 10\\
\hline
Nombre de parties gagnées par l'IA qui profile pendant jeu :& 15 sur 20\\
\hline
Gains de l'IA qui profile pendant profilage :& -924		\\
\hline
Gains de l'IA qui profile pendant jeu :&	3530		\\
\hline
\end{tabular}
\end{center}
...
Même si nous gagnons dans l'ensemble plus de parties que lors de la phase de scénarios de tests, nous avons néanmoins remarqué que dans l'ensemble, l'intelligence artificielle n'est pas gagnante en terme de nombre de jetons gagnés à la fin de dix parties. Le diagramme suivant représente le nombre de jetons gagnés par paliers, sur dix parties, pendant les scénarios de tests et après. On peut vite constater que, même si pour beaucoup de paliers nous avons un gain après les scénarios de tests plus élevé qu'avant, l'intelligence artificielle perd des jetons ou bien en gagne très peu. En effet, prenons par exemple le palier numéro 3, même si au départ le nombre de jetons perdus étaient de plus de 1000 sur dix parties et qu'ensuite l'intelligence artificielle gagnait environ 400 jetons, les résultats sont plutôt décevants. En effet, gagner seulement 400 jetons après avoir joué dix parties n'est pas énorme, nous avons pensé que nous pouvions sûrement trouver un calibrage qui permettrait à l'intelligence artificielle de gagner plus de 400 jetons.\par
...
La figure suivante correspond au résultat de la recherche du calibrage optimal face à un joueur 80\% agressif et 80\% rationnel. Comme on peut le voir, la courbe du nombre de de parties gagnées a tendance à croître de manière significative à partir du moment où on arrive aux calibrages ayant 75\% d'agressivité et plus. Concernant les jetons gagnés, on constate que la courbe dans son ensemble ne semble pas avoir un comportement défini. Après avoir analysé la courbe, nous avons choisi de calibrer notre intelligence artificielle à 100\% d'agressivité et 60\% de rationalité face à un joueur profilé avec un taux d'agressivité compris entre 60\% et 100\% et un taux de rationalité compris entre 60\% et 100\%. En effet, le calibrage choisi correspond au calibrage numéro 46 de la courbe. Comme on peut le voir, le résultat de ce calibrage est intéressant puisque l'intelligence artificielle a gagné beaucoup de parties et un nombre significatif de jetons.\par
...
%%%%%%%%%%%%TODO reprendre avec les nouveaux résultats %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Comparaison entre résultats nouveaux calibrages et anciens calibrages.
\begin{figure}[H]
	\begin{center}
