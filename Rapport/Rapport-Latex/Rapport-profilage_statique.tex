...
Nous avons donc choisi d'enregistrer dans nos fichiers de profilage un certain nombre de données. Tout d'abord, nous avons choisi d'enregistrer des données communes à toutes les parties : \\
	- AR (agressif rationnel)
	- AB (agressif bluffeur)
	- PR (passif rationnel)
	- PB (passif bluffer)
